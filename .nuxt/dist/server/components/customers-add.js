...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/customers/add.vue?vue&type=template&id=f1e36d6c&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('v-btn',{attrs:{"color":"primary"},on:{"click":function($event){_vm.addModel = true}}},[_vm._v("Add Customer "),_c('v-icon',{staticClass:"pl-3 mb-2"},[_vm._v("mdi-account-cog")])],1),_vm._ssrNode(" "),_c('v-dialog',{attrs:{"width":"1200"},model:{value:(_vm.addModel),callback:function ($$v) {_vm.addModel=$$v},expression:"addModel"}},[_c('v-form',{ref:"form",attrs:{"lazy-validation":""},model:{value:(_vm.valid),callback:function ($$v) {_vm.valid=$$v},expression:"valid"}},[_c('v-card',[_c('v-card-title',[_vm._v("\n          Add Customer\n          "),_c('v-spacer'),_vm._v(" "),_c('v-btn',{attrs:{"icon":""},on:{"click":function($event){_vm.addModel = false}}},[_c('v-icon',[_vm._v("mdi-close")])],1)],1),_vm._v(" "),_c('v-card-text',[_c('v-row',[_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"First Name","outlined":"","rules":_vm.fnameRule},model:{value:(_vm.form.name),callback:function ($$v) {_vm.$set(_vm.form, "name", $$v)},expression:"form.name"}})],1),_vm._v(" "),_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"Surname","outlined":"","rules":_vm.surnameRule},model:{value:(_vm.form.surname),callback:function ($$v) {_vm.$set(_vm.form, "surname", $$v)},expression:"form.surname"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"PMI Number","outlined":""},model:{value:(_vm.form.pmi_number),callback:function ($$v) {_vm.$set(_vm.form, "pmi_number", $$v)},expression:"form.pmi_number"}})],1),_vm._v(" "),_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"Email","type":"email","outlined":"","rules":_vm.emailRule},model:{value:(_vm.form.email),callback:function ($$v) {_vm.$set(_vm.form, "email", $$v)},expression:"form.email"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',{attrs:{"md":"6"}},[_c('v-select',{attrs:{"label":"Select Gender","outlined":"","rules":_vm.genderRule,"items":_vm.items,"item-text":"name","item-value":"id"},model:{value:(_vm.form.gender),callback:function ($$v) {_vm.$set(_vm.form, "gender", $$v)},expression:"form.gender"}})],1),_vm._v(" "),_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"Phone Number","outlined":"","rules":_vm.phoneNumberRule},model:{value:(_vm.form.phone),callback:function ($$v) {_vm.$set(_vm.form, "phone", $$v)},expression:"form.phone"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"Job Title","outlined":"","rules":_vm.job_titleRule},model:{value:(_vm.form.job_title),callback:function ($$v) {_vm.$set(_vm.form, "job_title", $$v)},expression:"form.job_title"}})],1),_vm._v(" "),_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"Physical Address","outlined":""},model:{value:(_vm.form.address),callback:function ($$v) {_vm.$set(_vm.form, "address", $$v)},expression:"form.address"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',{attrs:{"md":"6"}},[_c('v-select',{attrs:{"label":"Select Province","outlined":"","rules":_vm.provinceRule,"items":_vm.provinces,"item-text":"name","item-value":"id"},model:{value:(_vm.form.province),callback:function ($$v) {_vm.$set(_vm.form, "province", $$v)},expression:"form.province"}})],1),_vm._v(" "),_c('v-col',{attrs:{"md":"6"}},[_c('v-select',{attrs:{"items":_vm.industrial_sectors,"label":"Industry Sector","outlined":"","rules":_vm.industrial_sectorRule},model:{value:(_vm.form.industrial_sector),callback:function ($$v) {_vm.$set(_vm.form, "industrial_sector", $$v)},expression:"form.industrial_sector"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"append-icon":_vm.show1 ? 'mdi-eye' : 'mdi-eye-off',"rules":[_vm.passwordrules.required, _vm.passwordrules.min],"type":_vm.show1 ? 'text' : 'password',"name":"input-10-1","label":"Password","hint":"At least 8 characters","counter":"","outlined":""},on:{"click:append":function($event){_vm.show1 = !_vm.show1}},model:{value:(_vm.form.password),callback:function ($$v) {_vm.$set(_vm.form, "password", $$v)},expression:"form.password"}})],1),_vm._v(" "),_c('v-col',{attrs:{"cols":"12","sm":"6"}},[_c('v-text-field',{attrs:{"outlined":"","append-icon":_vm.show2 ? 'mdi-eye' : 'mdi-eye-off',"type":_vm.show2 ? 'text' : 'password',"label":"ConfirmPassword","hint":"At least 8 characters","counter":"","rules":_vm.confirmpasswordRule},on:{"click:append":function($event){_vm.show2 = !_vm.show2}},model:{value:(_vm.form.password_confirmation),callback:function ($$v) {_vm.$set(_vm.form, "password_confirmation", $$v)},expression:"form.password_confirmation"}})],1)],1)],1),_vm._v(" "),_c('v-card-actions',[_c('v-btn',{staticClass:"error",on:{"click":function($event){_vm.addPermModel = false}}},[_vm._v("Cancel")]),_vm._v(" "),_c('v-spacer'),_vm._v(" "),_c('v-btn',{staticClass:"success",attrs:{"loading":_vm.loading,"disabled":_vm.loading},on:{"click":_vm.submit}},[_vm._v("Submit")])],1)],1)],1)],1),_vm._ssrNode(" "),_c('v-snackbar',{attrs:{"absolute":"","color":_vm.color,"right":"","top":""},model:{value:(_vm.snackbar),callback:function ($$v) {_vm.snackbar=$$v},expression:"snackbar"}},[_vm._v(_vm._s(_vm.text))])],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/customers/add.vue?vue&type=template&id=f1e36d6c&
...
/* harmony default export */ var addvue_type_script_lang_js_ = ({
  data() {
    return {
      ...
      industrial_sectors: ['Administrative Services', 'Advertising', 'Aerospace', 'Agriculture', 'Airlines', 'Amusement & Recreation', 'Banking', 'Business Services', 'Chemicals', 'Construction', 'Consumer Discretionary', 'Consumer Services', 'Consumer Staples', 'Creative Industries (e.g. Music)', 'Cultural Industries', 'Education', 'Energy', 'Entertainment', 'Network and Communication', 'Mining Sector', 'Education', 'ICT and Telecoms', 'Energy', 'Engineering', 'Health and Safety', 'Manufacturing and Processing', 'Quality and business improvement', 'Risk', 'Security', 'Transport and Logistics', 'Waste and recycling', 'Welding', 'Data protection', 'Automotive', 'Banking and finance services', 'Biometrics', 'CSR and governance', 'Environmental management and sustainability', 'Healthcare', 'Import export', 'Innovation and design', 'Internet of things', 'Measurement and metrology', 'Medical devices', 'Fire', 'Fire', 'Graphics Technology'],
      addModel: false,
      valid: false,
      show1: false,
      show2: false,
      ...
      passwordrules: [v => !!v || 'Password is required', v => v && v.length >= 8 || 'Password must be greater than 8 characters'],
      confirmpasswordRule: [v => !!v || 'Password is required', v => v && v.length >= 8 || 'Password must be greater than 10 characters', v => v && v.length == this.form.password.length || 'Passwords must match'],
...
//# sourceMappingURL=customers-add.js.map