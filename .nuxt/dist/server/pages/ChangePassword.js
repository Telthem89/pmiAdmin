...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/ChangePassword.vue?vue&type=template&id=20f401f2&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-container',[_c('v-row',{staticClass:"mt-5"},[_c('v-col',{attrs:{"md":"8","offset-md":"2"}},[_c('v-card',{staticClass:"mt-4"},[_c('v-card-title',[_vm._v("Change Password")]),_vm._v(" "),_c('v-card-text',[_c('v-form',{ref:"form",attrs:{"lazy-validation":""},model:{value:(_vm.valid),callback:function ($$v) {_vm.valid=$$v},expression:"valid"}},[_c('v-text-field',{attrs:{"append-icon":_vm.show1 ? 'mdi-eye' : 'mdi-eye-off',"rules":[_vm.passwordrules.required, _vm.passwordrules.min],"type":_vm.show1 ? 'text' : 'password',"name":"input-10-1","label":"New Password","hint":"At least 8 characters","counter":"","outlined":""},on:{"click:append":function($event){_vm.show1 = !_vm.show1}},model:{value:(_vm.form.password),callback:function ($$v) {_vm.$set(_vm.form, "password", $$v)},expression:"form.password"}}),_vm._v(" "),_c('v-text-field',{attrs:{"append-icon":_vm.show1 ? 'mdi-eye' : 'mdi-eye-off',"rules":[_vm.passwordrules.required, _vm.passwordrules.min,_vm.passwordrules.confirm],"type":_vm.show2 ? 'text' : 'password',"name":"input-10-1","label":"Confirm Password","hint":"At least 8 characters","counter":"","outlined":""},on:{"click:append":function($event){_vm.show2 = !_vm.show2}},model:{value:(_vm.form.confirmpassword),callback:function ($$v) {_vm.$set(_vm.form, "confirmpassword", $$v)},expression:"form.confirmpassword"}}),_vm._v(" "),_c('v-btn',{staticClass:"indigo darken-4 white--text",attrs:{"large":"","depressed":"","block":"","loading":_vm.loading,"disabled":_vm.loading},on:{"click":_vm.submit}},[_vm._v("Submit")])],1)],1)],1)],1)],1),_vm._v(" "),_c('v-snackbar',{attrs:{"absolute":"","color":_vm.color,"right":"","top":""},model:{value:(_vm.snackbar),callback:function ($$v) {_vm.snackbar=$$v},expression:"snackbar"}},[_vm._v(_vm._s(_vm.text))])],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/ChangePassword.vue?vue&type=template&id=20f401f2&
...
installComponents_default()(component, {VBtn: VBtn["a" /* default */],VCard: VCard["a" /* default */],VCardText: components_VCard["b" /* VCardText */],VCardTitle: components_VCard["c" /* VCardTitle */],VCol: VCol["a" /* default */],VContainer: VContainer["a" /* default */],VForm: VForm["a" /* default */],VRow: VRow["a" /* default */],VSnackbar: VSnackbar["a" /* default */],VTextField: VTextField["a" /* default */]})
