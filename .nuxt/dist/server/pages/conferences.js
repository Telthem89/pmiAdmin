...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/conferences/edit.vue?vue&type=template&id=382eed4a&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('v-btn',{attrs:{"icon":"","depressed":"","color":"primary"},on:{"click":function($event){_vm.addPermModel = true}}},[_c('v-icon',[_vm._v("mdi-pencil")])],1),_vm._ssrNode(" "),_c('v-dialog',{attrs:{"width":"1200"},model:{value:(_vm.addPermModel),callback:function ($$v) {_vm.addPermModel=$$v},expression:"addPermModel"}},[_c('v-form',{ref:"form",attrs:{"lazy-validation":""},model:{value:(_vm.valid),callback:function ($$v) {_vm.valid=$$v},expression:"valid"}},[_c('v-card',[_c('v-card-title',[_vm._v("\n            Update Event\n            "),_c('v-spacer'),_vm._v(" "),_c('v-btn',{attrs:{"icon":""},on:{"click":function($event){_vm.addPermModel = false}}},[_c('v-icon',[_vm._v("mdi-close")])],1)],1),_vm._v(" "),_c('v-card-text',[_c('v-row',[_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"Event Name","outlined":"","rules":_vm.eventnameRule},model:{value:(_vm.form.eventname),callback:function ($$v) {_vm.$set(_vm.form, "eventname", $$v)},expression:"form.eventname"}})],1),_vm._v(" "),_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"Short Description","outlined":"","rules":_vm.descriptionshortRule},model:{value:(_vm.form.descriptionshort),callback:function ($$v) {_vm.$set(_vm.form, "descriptionshort", $$v)},expression:"form.descriptionshort"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"Learning Outcome","outlined":"","rules":_vm.learningoutcomeRule},model:{value:(_vm.form.learningoutcome),callback:function ($$v) {_vm.$set(_vm.form, "learningoutcome", $$v)},expression:"form.learningoutcome"}})],1),_vm._v(" "),_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"Opening Date","outlined":"","rules":_vm.opendateRule,"type":"date"},model:{value:(_vm.form.opendate),callback:function ($$v) {_vm.$set(_vm.form, "opendate", $$v)},expression:"form.opendate"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"Closing Date","outlined":"","rules":_vm.closedateRule,"type":"date"},model:{value:(_vm.form.closedate),callback:function ($$v) {_vm.$set(_vm.form, "closedate", $$v)},expression:"form.closedate"}})],1),_vm._v(" "),_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"Fee","outlined":"","rules":_vm.individual_PriceRule},model:{value:(_vm.form.individual_Price),callback:function ($$v) {_vm.$set(_vm.form, "individual_Price", $$v)},expression:"form.individual_Price"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"objective One","outlined":""},model:{value:(_vm.form.objectiveOne),callback:function ($$v) {_vm.$set(_vm.form, "objectiveOne", $$v)},expression:"form.objectiveOne"}})],1),_vm._v(" "),_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"objective Two [Optional]","outlined":""},model:{value:(_vm.form.objectiveTwo),callback:function ($$v) {_vm.$set(_vm.form, "objectiveTwo", $$v)},expression:"form.objectiveTwo"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"objective Three [Optional]","outlined":""},model:{value:(_vm.form.objectiveThree),callback:function ($$v) {_vm.$set(_vm.form, "objectiveThree", $$v)},expression:"form.objectiveThree"}})],1),_vm._v(" "),_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"objective Four [Optional]","outlined":""},model:{value:(_vm.form.objectiveFour),callback:function ($$v) {_vm.$set(_vm.form, "objectiveFour", $$v)},expression:"form.objectiveFour"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"objective Five [Optional]","outlined":""},model:{value:(_vm.form.objectiveSix),callback:function ($$v) {_vm.$set(_vm.form, "objectiveSix", $$v)},expression:"form.objectiveSix"}})],1),_vm._v(" "),_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"objective Six [Optional]","outlined":""},model:{value:(_vm.form.objectiveSeven),callback:function ($$v) {_vm.$set(_vm.form, "objectiveSeven", $$v)},expression:"form.objectiveSeven"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"Location","outlined":""},model:{value:(_vm.form.location),callback:function ($$v) {_vm.$set(_vm.form, "location", $$v)},expression:"form.location"}})],1),_vm._v(" "),_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"webinarid","outlined":""},model:{value:(_vm.form.webinarid),callback:function ($$v) {_vm.$set(_vm.form, "webinarid", $$v)},expression:"form.webinarid"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"webinarurl","outlined":""},model:{value:(_vm.form.webinarurl),callback:function ($$v) {_vm.$set(_vm.form, "webinarurl", $$v)},expression:"form.webinarurl"}})],1),_vm._v(" "),_c('v-col',{attrs:{"md":"6"}},[_c('v-file-input',{attrs:{"accept":".png,.jpeg,.jpg","label":"Upload Feature Image","rules":_vm.fileRule},model:{value:(_vm.form.file),callback:function ($$v) {_vm.$set(_vm.form, "file", $$v)},expression:"form.file"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"Conference Start Time","outlined":"","type":"time"},model:{value:(_vm.form.opentime),callback:function ($$v) {_vm.$set(_vm.form, "opentime", $$v)},expression:"form.opentime"}})],1),_vm._v(" "),_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"Conference closing Time","outlined":"","type":"time"},model:{value:(_vm.form.closetime),callback:function ($$v) {_vm.$set(_vm.form, "closetime", $$v)},expression:"form.closetime"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',{attrs:{"md":"6"}},[_c('v-select',{attrs:{"items":_vm.speakers,"label":"Select Speaker","outlined":"","item-value":"id","item-text":"name"},model:{value:(_vm.form.speakerId),callback:function ($$v) {_vm.$set(_vm.form, "speakerId", $$v)},expression:"form.speakerId"}})],1),_vm._v(" "),_c('v-col',{attrs:{"md":"6"}})],1)],1),_vm._v(" "),_c('v-card-actions',[_c('v-btn',{staticClass:"error",on:{"click":function($event){_vm.addPermModel = false}}},[_vm._v("Cancel")]),_vm._v(" "),_c('v-spacer'),_vm._v(" "),_c('v-btn',{staticClass:"success",attrs:{"loading":_vm.loading,"disabled":_vm.loading},on:{"click":_vm.submit}},[_vm._v("Submit")])],1)],1)],1)],1),_vm._ssrNode(" "),_c('v-snackbar',{attrs:{"color":_vm.color,"right":"","top":""},model:{value:(_vm.snackbar),callback:function ($$v) {_vm.snackbar=$$v},expression:"snackbar"}},[_vm._v(_vm._s(_vm.text))])],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/conferences/edit.vue?vue&type=template&id=382eed4a&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/conferences/edit.vue?vue&type=script&lang=js&
//
//
//
//
...
// CONCATENATED MODULE: ./components/conferences/edit.vue?vue&type=script&lang=js&
 /* harmony default export */ var conferences_editvue_type_script_lang_js_ = (editvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(16);
...
// CONCATENATED MODULE: ./components/conferences/edit.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  conferences_editvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/conferences/delete.vue?vue&type=template&id=60183a5d&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('v-btn',{attrs:{"icon":"","depressed":"","color":"error"},on:{"click":function($event){_vm.addPermModel=true}}},[_c('v-icon',[_vm._v("mdi-trash-can")])],1),_vm._ssrNode(" "),_c('v-dialog',{attrs:{"width":"300"},model:{value:(_vm.addPermModel),callback:function ($$v) {_vm.addPermModel=$$v},expression:"addPermModel"}},[_c('v-form',{ref:"form",attrs:{"lazy-validation":""},model:{value:(_vm.valid),callback:function ($$v) {_vm.valid=$$v},expression:"valid"}},[_c('v-card',[_c('v-card-title',[_vm._v("\n             Delete Customer "),_c('v-icon',[_vm._v("mdi-warning")]),_vm._v(" "),_c('v-spacer'),_vm._v(" "),_c('v-btn',{attrs:{"icon":""},on:{"click":function($event){_vm.addPermModel=false}}},[_c('v-icon',[_vm._v("mdi-close")])],1)],1),_vm._v(" "),_c('v-card-text',{staticClass:"text-center"},[_c('v-alert',{attrs:{"outlined":"","type":"error","prominent":"","border":"left"}},[_vm._v("\n                      You are about to delete  "),_c('b',[_vm._v(_vm._s(_vm.event.eventname))])])],1),_vm._v(" "),_c('v-card-actions',[_c('v-btn',{staticClass:"error",on:{"click":function($event){_vm.addPermModel=false}}},[_vm._v("Cancel")]),_vm._v(" "),_c('v-spacer'),_vm._v(" "),_c('v-btn',{staticClass:"success",attrs:{"loading":_vm.loading,"disabled":_vm.loading},on:{"click":_vm.submit}},[_vm._v("Submit")])],1)],1)],1)],1),_vm._ssrNode(" "),_c('v-snackbar',{attrs:{"color":_vm.color,"right":"","top":""},model:{value:(_vm.snackbar),callback:function ($$v) {_vm.snackbar=$$v},expression:"snackbar"}},[_vm._v(_vm._s(_vm.text))])],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/conferences/delete.vue?vue&type=template&id=60183a5d&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/conferences/delete.vue?vue&type=script&lang=js&
//
//
//
//
  ...
  methods: {
    async submit() {
      if (this.$refs.form.validate()) {
        ...
        try {
          await this.$axios.delete('api/admin/events/' + this.event.id).then(res => {
            this.loading = false;
            this.color = "success";
            this.snackbar = true;
            this.text = res.data.message;
...
// CONCATENATED MODULE: ./components/conferences/delete.vue?vue&type=script&lang=js&
 /* harmony default export */ var conferences_deletevue_type_script_lang_js_ = (deletevue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(16);
...
// CONCATENATED MODULE: ./components/conferences/delete.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  conferences_deletevue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
/* harmony default export */ var conferences_delete = __webpack_exports__["default"] = (component.exports);
...
// CONCATENATED MODULE: ./pages/conferences.vue?vue&type=script&lang=js&
 /* harmony default export */ var pages_conferencesvue_type_script_lang_js_ = (conferencesvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(16);
...
// CONCATENATED MODULE: ./pages/conferences.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  pages_conferencesvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
/* harmony default export */ var conferences = __webpack_exports__["default"] = (component.exports);

/* nuxt-component-imports */
installComponents_default()(component, {ConferencesAdd: __webpack_require__(558).default,ConferencesEdit: __webpack_require__(559).default,ConferencesDelete: __webpack_require__(560).default})
