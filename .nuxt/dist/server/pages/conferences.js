...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/conferences/add.vue?vue&type=template&id=76d62fff&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('v-btn',{attrs:{"depressed":"","color":"primary"},on:{"click":function($event){_vm.addPermModel = true}}},[_vm._v("Add Event"),_c('v-icon',[_vm._v("mdi-calendar")])],1),_vm._ssrNode(" "),_c('v-dialog',{attrs:{"width":"1200"},model:{value:(_vm.addPermModel),callback:function ($$v) {_vm.addPermModel=$$v},expression:"addPermModel"}},[_c('v-form',{ref:"form",attrs:{"lazy-validation":""},model:{value:(_vm.valid),callback:function ($$v) {_vm.valid=$$v},expression:"valid"}},[_c('v-card',[_c('v-card-title',[_vm._v("\n          Add Event\n          "),_c('v-spacer'),_vm._v(" "),_c('v-btn',{attrs:{"icon":""},on:{"click":function($event){_vm.addPermModel = false}}},[_c('v-icon',[_vm._v("mdi-close")])],1)],1),_vm._v(" "),_c('v-card-text',[_c('v-row',[_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"Event Name","outlined":""},model:{value:(_vm.form.eventname),callback:function ($$v) {_vm.$set(_vm.form, "eventname", $$v)},expression:"form.eventname"}})],1),_vm._v(" "),_c('v-col',{attrs:{"md":"6"}},[_c('v-file-input',{attrs:{"accept":".png,.jpeg,.jpg","label":"Upload Feature Image"},model:{value:(_vm.form.file),callback:function ($$v) {_vm.$set(_vm.form, "file", $$v)},expression:"form.file"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"Opening Date","outlined":"","type":"date"},model:{value:(_vm.form.opendate),callback:function ($$v) {_vm.$set(_vm.form, "opendate", $$v)},expression:"form.opendate"}})],1),_vm._v(" "),_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"Closing Date","outlined":"","type":"date"},model:{value:(_vm.form.closedate),callback:function ($$v) {_vm.$set(_vm.form, "closedate", $$v)},expression:"form.closedate"}})],1)],1)],1),_vm._v(" "),_c('v-card-actions',[_c('v-btn',{staticClass:"error",on:{"click":function($event){_vm.addPermModel = false}}},[_vm._v("Cancel")]),_vm._v(" "),_c('v-spacer'),_vm._v(" "),_c('v-btn',{staticClass:"success",attrs:{"loading":_vm.loading,"disabled":_vm.loading},on:{"click":_vm.submit}},[_vm._v("Submit")])],1)],1)],1)],1),_vm._ssrNode(" "),_c('v-snackbar',{attrs:{"color":_vm.color,"right":"","top":""},model:{value:(_vm.snackbar),callback:function ($$v) {_vm.snackbar=$$v},expression:"snackbar"}},[_vm._v(_vm._s(_vm.text))])],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/conferences/add.vue?vue&type=template&id=76d62fff&
  ...
  methods: {
    async submit() {
      if (this.$refs.form.validate()) {
        ...
        try {
          await this.$axios.post('api/admin/eventsessions', this.form).then(res => {
            this.loading = false;
            this.color = "success";
            this.snackbar = true;
            this.text = res.data.message;
            this.$store.dispatch('conferences/getConferencesessions', this.eventdata.id); // this.$store.dispatch('conferences/getConferencesessions')
...
// CONCATENATED MODULE: ./components/sessions/add.vue?vue&type=script&lang=js&
 /* harmony default export */ var sessions_addvue_type_script_lang_js_ = (addvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(21);
...
// CONCATENATED MODULE: ./components/sessions/add.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  sessions_addvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/sessions/edit.vue?vue&type=template&id=e2527cb4&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('v-btn',{attrs:{"icon":"","depressed":"","color":"primary"},on:{"click":function($event){_vm.addPermModel=true}}},[_c('v-icon',[_vm._v("mdi-pencil")])],1),_vm._ssrNode(" "),_c('v-dialog',{attrs:{"width":"500"},model:{value:(_vm.addPermModel),callback:function ($$v) {_vm.addPermModel=$$v},expression:"addPermModel"}},[_c('v-form',{ref:"form",attrs:{"lazy-validation":""},model:{value:(_vm.valid),callback:function ($$v) {_vm.valid=$$v},expression:"valid"}},[_c('v-card',[_c('v-card-title',[_vm._v("\n             Update Session\n             "),_c('v-spacer'),_vm._v(" "),_c('v-btn',{attrs:{"icon":""},on:{"click":function($event){_vm.addPermModel=false}}},[_c('v-icon',[_vm._v("mdi-close")])],1)],1),_vm._v(" "),_c('v-card-text',[_c('v-text-field',{attrs:{"label":"Session Name","outlined":"","rules":_vm.session_nameRule},model:{value:(_vm.form.session_name),callback:function ($$v) {_vm.$set(_vm.form, "session_name", $$v)},expression:"form.session_name"}}),_vm._v(" "),_c('v-text-field',{attrs:{"label":"Date","outlined":"","type":"Date","rules":_vm.eventsession_dateRule},model:{value:(_vm.form.eventsession_date),callback:function ($$v) {_vm.$set(_vm.form, "eventsession_date", $$v)},expression:"form.eventsession_date"}}),_vm._v(" "),_c('v-select',{attrs:{"label":"Assign Speaker","outlined":"","items":_vm.speakers,"item-text":"name","item-value":"id","rules":_vm.speakerIdRule},model:{value:(_vm.form.speakerId),callback:function ($$v) {_vm.$set(_vm.form, "speakerId", $$v)},expression:"form.speakerId"}}),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.form.conferenceeventId),expression:"form.conferenceeventId"}],attrs:{"type":"hidden"},domProps:{"value":(_vm.form.conferenceeventId)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.form, "conferenceeventId", $event.target.value)}}})],1),_vm._v(" "),_c('v-card-actions',[_c('v-btn',{staticClass:"error",on:{"click":function($event){_vm.addPermModel=false}}},[_vm._v("Cancel")]),_vm._v(" "),_c('v-spacer'),_vm._v(" "),_c('v-btn',{staticClass:"success",attrs:{"loading":_vm.loading,"disabled":_vm.loading},on:{"click":_vm.submit}},[_vm._v("Submit")])],1)],1)],1)],1),_vm._ssrNode(" "),_c('v-snackbar',{attrs:{"color":_vm.color,"right":"","top":""},model:{value:(_vm.snackbar),callback:function ($$v) {_vm.snackbar=$$v},expression:"snackbar"}},[_vm._v(_vm._s(_vm.text))])],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/sessions/edit.vue?vue&type=template&id=e2527cb4&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/sessions/edit.vue?vue&type=script&lang=js&
//
//
//
//
      ...
      if (this.$refs.form.validate()) {
        ...
        try {
          await this.$axios.patch('api/admin/eventsessions/' + this.eventdata.id, this.form).then(res => {
            ...
            this.snackbar = true;
            this.text = res.data.message;
            this.$store.dispatch('conferences/getConferencesessions', this.eventdata.conferenceeventId); // this.$store.dispatch('conferences/getConferencesessions')
...
// CONCATENATED MODULE: ./components/sessions/edit.vue?vue&type=script&lang=js&
 /* harmony default export */ var sessions_editvue_type_script_lang_js_ = (editvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(21);
...
// CONCATENATED MODULE: ./components/sessions/edit.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  sessions_editvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/conferences/edit.vue?vue&type=template&id=ec5514c0&
...
// CONCATENATED MODULE: ./components/conferences/edit.vue?vue&type=template&id=ec5514c0&
...
// CONCATENATED MODULE: ./components/conferences/view.vue?vue&type=script&lang=js&
 /* harmony default export */ var conferences_viewvue_type_script_lang_js_ = (viewvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(21);
...
// CONCATENATED MODULE: ./components/conferences/view.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  conferences_viewvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
installComponents_default()(component, {SessionsAdd: __webpack_require__(705).default,SessionsEdit: __webpack_require__(706).default})
...
/* nuxt-component-imports */
installComponents_default()(component, {ConferencesAdd: __webpack_require__(704).default,ConferencesEdit: __webpack_require__(744).default,ConferencesDelete: __webpack_require__(745).default,ConferencesView: __webpack_require__(746).default})
