...
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
__webpack_require__(6).default("5db1c400", content, true)
...
/* harmony default export */ var transitionable = (vue_runtime_common_default.a.extend({
  name: 'transitionable',
  props: {
    mode: String,
    origin: String,
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/customers/add.vue?vue&type=template&id=a159718c&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('v-btn',{attrs:{"color":"primary"},on:{"click":function($event){_vm.addModel = true}}},[_vm._v("Add Customer "),_c('v-icon',{staticClass:"pl-3 mb-2"},[_vm._v("mdi-account-cog")])],1),_vm._ssrNode(" "),_c('v-dialog',{attrs:{"width":"1200"},model:{value:(_vm.addModel),callback:function ($$v) {_vm.addModel=$$v},expression:"addModel"}},[_c('v-form',{ref:"form",attrs:{"lazy-validation":""},model:{value:(_vm.valid),callback:function ($$v) {_vm.valid=$$v},expression:"valid"}},[_c('v-card',[_c('v-card-title',[_vm._v("\n          Add Customer\n          "),_c('v-spacer'),_vm._v(" "),_c('v-btn',{attrs:{"icon":""},on:{"click":function($event){_vm.addModel = false}}},[_c('v-icon',[_vm._v("mdi-close")])],1)],1),_vm._v(" "),_c('v-card-text',[_c('v-row',[_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"First Name","outlined":"","rules":_vm.fnameRule},model:{value:(_vm.form.name),callback:function ($$v) {_vm.$set(_vm.form, "name", $$v)},expression:"form.name"}})],1),_vm._v(" "),_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"Surname","outlined":"","rules":_vm.surnameRule},model:{value:(_vm.form.surname),callback:function ($$v) {_vm.$set(_vm.form, "surname", $$v)},expression:"form.surname"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"Username","outlined":"","rules":_vm.usernameRule},model:{value:(_vm.form.username),callback:function ($$v) {_vm.$set(_vm.form, "username", $$v)},expression:"form.username"}})],1),_vm._v(" "),_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"Email","type":"email","outlined":"","rules":_vm.emailRule},model:{value:(_vm.form.email),callback:function ($$v) {_vm.$set(_vm.form, "email", $$v)},expression:"form.email"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',{attrs:{"md":"6"}},[_c('v-select',{attrs:{"label":"Select Gender","outlined":"","rules":_vm.genderRule,"items":_vm.items,"item-text":"name","item-value":"id"},model:{value:(_vm.form.gender),callback:function ($$v) {_vm.$set(_vm.form, "gender", $$v)},expression:"form.gender"}})],1),_vm._v(" "),_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"Phone Number","outlined":"","rules":_vm.phoneNumberRule},model:{value:(_vm.form.phone),callback:function ($$v) {_vm.$set(_vm.form, "phone", $$v)},expression:"form.phone"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',{attrs:{"md":"6"}},[_c('v-select',{attrs:{"label":"Select Province","outlined":"","rules":_vm.provinceRule,"items":_vm.provinces,"item-text":"name","item-value":"id"},model:{value:(_vm.form.province),callback:function ($$v) {_vm.$set(_vm.form, "province", $$v)},expression:"form.province"}})],1),_vm._v(" "),_c('v-col',{attrs:{"md":"6"}},[_c('v-select',{attrs:{"items":_vm.computeList,"label":"District","outlined":"","rules":_vm.districtRule},model:{value:(_vm.form.district),callback:function ($$v) {_vm.$set(_vm.form, "district", $$v)},expression:"form.district"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"append-icon":_vm.show1 ? 'mdi-eye' : 'mdi-eye-off',"rules":[_vm.passwordrules.required, _vm.passwordrules.min],"type":_vm.show1 ? 'text' : 'password',"name":"input-10-1","label":"Password","hint":"At least 8 characters","counter":"","outlined":""},on:{"click:append":function($event){_vm.show1 = !_vm.show1}},model:{value:(_vm.form.password),callback:function ($$v) {_vm.$set(_vm.form, "password", $$v)},expression:"form.password"}})],1),_vm._v(" "),_c('v-col',{attrs:{"cols":"12","sm":"6"}},[_c('v-text-field',{attrs:{"outlined":"","append-icon":_vm.show2 ? 'mdi-eye' : 'mdi-eye-off',"type":_vm.show2 ? 'text' : 'password',"label":"ConfirmPassword","hint":"At least 8 characters","counter":"","rules":_vm.confirmpasswordRule},on:{"click:append":function($event){_vm.show2 = !_vm.show2}},model:{value:(_vm.form.password_confirmation),callback:function ($$v) {_vm.$set(_vm.form, "password_confirmation", $$v)},expression:"form.password_confirmation"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"City","outlined":""},model:{value:(_vm.form.city),callback:function ($$v) {_vm.$set(_vm.form, "city", $$v)},expression:"form.city"}})],1),_vm._v(" "),_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"Company Name","outlined":""},model:{value:(_vm.form.company_name),callback:function ($$v) {_vm.$set(_vm.form, "company_name", $$v)},expression:"form.company_name"}})],1)],1)],1),_vm._v(" "),_c('v-card-actions',[_c('v-btn',{staticClass:"error",on:{"click":function($event){_vm.addPermModel = false}}},[_vm._v("Cancel")]),_vm._v(" "),_c('v-spacer'),_vm._v(" "),_c('v-btn',{staticClass:"success",attrs:{"loading":_vm.loading,"disabled":_vm.loading},on:{"click":_vm.submit}},[_vm._v("Submit")])],1)],1)],1)],1),_vm._ssrNode(" "),_c('v-snackbar',{attrs:{"absolute":"","color":_vm.color,"right":"","top":""},model:{value:(_vm.snackbar),callback:function ($$v) {_vm.snackbar=$$v},expression:"snackbar"}},[_vm._v(_vm._s(_vm.text))])],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/customers/add.vue?vue&type=template&id=a159718c&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/customers/add.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var addvue_type_script_lang_js_ = ({
  data() {
    return {
      items: ["Male", "Female"],
      provinces: ["Harare", "Bulawayo", "Masvingo", "Midlands", "Manicaland", "Mashonaland East", "Mashonaland West", "Mashonaland Central", "Matebeleland North", "Matebeleland South"],
      addModel: false,
      valid: false,
      show1: false,
      show2: false,
  ...
  computed: {
    computeList() {
      ...
      if (this.form.province == "Matabeleland South") {
        ...
        list = ["Binga", "Bubi", "Hwange", "Lupane", "Nkayi", "Tsholotsho", "Umguza", "Victoria Falls"];
        ...
        list = ["Chirumhanzu", "Gokwe North", "Gokwe South", "Gweru", "Kwekwe", "Mberengwa", "Shurugwi", "Zvishavane", "Rusape", "Buhera", "Chipinge Urban", "Chipinge Rural", "Makoni", "Mutasa", "Mutare"];
        ...
        list = ["Harare", "Chitungwiza", "Epworth", "Harare Urban", "Harare Rural"];
      }
...
// CONCATENATED MODULE: ./components/customers/add.vue?vue&type=script&lang=js&
 /* harmony default export */ var customers_addvue_type_script_lang_js_ = (addvue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./components/customers/add.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  customers_addvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/customers/edit.vue?vue&type=template&id=f08f9e0c&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('v-btn',{attrs:{"icon":"","color":"primary"},on:{"click":function($event){_vm.addModel = true}}},[_c('v-icon',{staticClass:"pl-3 mb-2"},[_vm._v("mdi-pencil")])],1),_vm._ssrNode(" "),_c('v-dialog',{attrs:{"width":"1200"},model:{value:(_vm.addModel),callback:function ($$v) {_vm.addModel=$$v},expression:"addModel"}},[_c('v-form',{ref:"form",attrs:{"lazy-validation":""},model:{value:(_vm.valid),callback:function ($$v) {_vm.valid=$$v},expression:"valid"}},[_c('v-card',[_c('v-card-title',[_vm._v("\n          Update Customer Details \n          "),_c('v-spacer'),_vm._v(" "),_c('v-btn',{attrs:{"icon":""},on:{"click":function($event){_vm.addModel = false}}},[_c('v-icon',[_vm._v("mdi-close")])],1)],1),_vm._v(" "),_c('v-card-text',[_c('v-row',[_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"First Name","outlined":""},model:{value:(_vm.form.name),callback:function ($$v) {_vm.$set(_vm.form, "name", $$v)},expression:"form.name"}})],1),_vm._v(" "),_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"Surname","outlined":""},model:{value:(_vm.form.surname),callback:function ($$v) {_vm.$set(_vm.form, "surname", $$v)},expression:"form.surname"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"Username","outlined":""},model:{value:(_vm.form.username),callback:function ($$v) {_vm.$set(_vm.form, "username", $$v)},expression:"form.username"}})],1),_vm._v(" "),_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"Email","type":"email","outlined":""},model:{value:(_vm.form.email),callback:function ($$v) {_vm.$set(_vm.form, "email", $$v)},expression:"form.email"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',{attrs:{"md":"6"}},[_c('v-select',{attrs:{"label":"Select Gender","outlined":"","items":_vm.items,"item-text":"name","item-value":"id"},model:{value:(_vm.form.gender),callback:function ($$v) {_vm.$set(_vm.form, "gender", $$v)},expression:"form.gender"}})],1),_vm._v(" "),_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"Phone Number","outlined":""},model:{value:(_vm.form.phone),callback:function ($$v) {_vm.$set(_vm.form, "phone", $$v)},expression:"form.phone"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',{attrs:{"md":"6"}},[_c('v-select',{attrs:{"label":"Select Province","outlined":"","items":_vm.provinces,"item-text":"name","item-value":"id"},model:{value:(_vm.form.province),callback:function ($$v) {_vm.$set(_vm.form, "province", $$v)},expression:"form.province"}})],1),_vm._v(" "),_c('v-col',{attrs:{"md":"6"}},[_c('v-select',{attrs:{"items":_vm.computeList,"label":"District","outlined":""},model:{value:(_vm.form.district),callback:function ($$v) {_vm.$set(_vm.form, "district", $$v)},expression:"form.district"}})],1)],1),_vm._v(" "),_c('v-row',[_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"City","outlined":""},model:{value:(_vm.form.city),callback:function ($$v) {_vm.$set(_vm.form, "city", $$v)},expression:"form.city"}})],1),_vm._v(" "),_c('v-col',{attrs:{"md":"6"}},[_c('v-text-field',{attrs:{"label":"Company Name","outlined":""},model:{value:(_vm.form.company_name),callback:function ($$v) {_vm.$set(_vm.form, "company_name", $$v)},expression:"form.company_name"}})],1)],1)],1),_vm._v(" "),_c('v-card-actions',[_c('v-btn',{staticClass:"error",on:{"click":function($event){_vm.addPermModel = false}}},[_vm._v("Cancel")]),_vm._v(" "),_c('v-spacer'),_vm._v(" "),_c('v-btn',{staticClass:"success",attrs:{"loading":_vm.loading,"disabled":_vm.loading},on:{"click":_vm.submit}},[_vm._v("Submit")])],1)],1)],1)],1),_vm._ssrNode(" "),_c('v-snackbar',{attrs:{"absolute":"","color":_vm.color,"right":"","top":""},model:{value:(_vm.snackbar),callback:function ($$v) {_vm.snackbar=$$v},expression:"snackbar"}},[_vm._v(_vm._s(_vm.text))])],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/customers/edit.vue?vue&type=template&id=f08f9e0c&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/customers/edit.vue?vue&type=script&lang=js&
//
//
//
//
  ...
  methods: {
    async submit() {
      if (this.$refs.form.validate()) {
        ...
        try {
          this.$axios.patch("/api/admin/customers/" + this.cust.id, this.form).then(res => {
            this.$swal("success", res.data.message, "success");
            this.$store.dispatch("customers/getCustomers");
            this.$refs.form.reset();
            this.addModel = false;
...
// CONCATENATED MODULE: ./components/customers/edit.vue?vue&type=script&lang=js&
 /* harmony default export */ var customers_editvue_type_script_lang_js_ = (editvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(16);
...
var component = Object(componentNormalizer["a" /* default */])(
  customers_editvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/customers/delete.vue?vue&type=template&id=622194dc&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('v-btn',{attrs:{"icon":"","depressed":"","color":"error"},on:{"click":function($event){_vm.addPermModel=true}}},[_c('v-icon',[_vm._v("mdi-trash-can")])],1),_vm._ssrNode(" "),_c('v-dialog',{attrs:{"width":"300"},model:{value:(_vm.addPermModel),callback:function ($$v) {_vm.addPermModel=$$v},expression:"addPermModel"}},[_c('v-form',{ref:"form",attrs:{"lazy-validation":""},model:{value:(_vm.valid),callback:function ($$v) {_vm.valid=$$v},expression:"valid"}},[_c('v-card',[_c('v-card-title',[_vm._v("\n             Delete Customer "),_c('v-icon',[_vm._v("mdi-warning")]),_vm._v(" "),_c('v-spacer'),_vm._v(" "),_c('v-btn',{attrs:{"icon":""},on:{"click":function($event){_vm.addPermModel=false}}},[_c('v-icon',[_vm._v("mdi-close")])],1)],1),_vm._v(" "),_c('v-card-text',{staticClass:"text-center"},[_c('v-alert',{attrs:{"outlined":"","type":"error","prominent":"","border":"left"}},[_vm._v("\n                      You are about to delete  "),_c('b',[_vm._v(_vm._s(_vm.cust.name))])])],1),_vm._v(" "),_c('v-card-actions',[_c('v-btn',{staticClass:"error",on:{"click":function($event){_vm.addPermModel=false}}},[_vm._v("Cancel")]),_vm._v(" "),_c('v-spacer'),_vm._v(" "),_c('v-btn',{staticClass:"success",attrs:{"loading":_vm.loading,"disabled":_vm.loading},on:{"click":_vm.submit}},[_vm._v("Submit")])],1)],1)],1)],1),_vm._ssrNode(" "),_c('v-snackbar',{attrs:{"color":_vm.color,"right":"","top":""},model:{value:(_vm.snackbar),callback:function ($$v) {_vm.snackbar=$$v},expression:"snackbar"}},[_vm._v(_vm._s(_vm.text))])],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/customers/delete.vue?vue&type=template&id=622194dc&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/customers/delete.vue?vue&type=script&lang=js&
//
//
//
//
  ...
  methods: {
    async submit() {
      if (this.$refs.form.validate()) {
        ...
        try {
          await this.$axios.delete('api/admin/customers/' + this.cust.id).then(res => {
            this.loading = false;
            this.color = "success";
            this.snackbar = true;
...
// CONCATENATED MODULE: ./components/customers/delete.vue?vue&type=script&lang=js&
 /* harmony default export */ var customers_deletevue_type_script_lang_js_ = (deletevue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(16);
...
var VAlert = __webpack_require__(531);
...
// CONCATENATED MODULE: ./components/customers/delete.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  customers_deletevue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
/* harmony default export */ var customers_delete = __webpack_exports__["default"] = (component.exports);
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/customers.vue?vue&type=template&id=4b23f84c&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-container',[_c('v-row',[_c('v-col',[_c('v-card',[_c('v-card-text',{staticClass:"d-flex"},[_c('v-btn',{attrs:{"text":"","to":"dashboard"}},[_vm._v("Dashboard")]),_vm._v(" "),_c('v-btn',{attrs:{"text":"","disabled":""}},[_vm._v("Customers")])],1)],1)],1)],1),_vm._v(" "),_c('v-row',{staticClass:"mt-5"},[_c('v-col',[_c('v-card',[_c('v-card-title',[_vm._v("\n          Customers\n          "),_c('v-spacer'),_vm._v(" "),_c('CustomersAdd')],1),_vm._v(" "),_c('v-card-text',[_c('v-row',[_c('v-col',{attrs:{"lg":"8","md":"8"}},[_c('downloadexcel',{attrs:{"data":_vm.customerToexported}},[_c('v-btn',{staticClass:"error",attrs:{"depressed":""}},[_vm._v("Export Excel file")])],1)],1),_vm._v(" "),_c('v-col',{attrs:{"lg":"4","md":"4"}},[_c('v-text-field',{attrs:{"outlined":"","width":"100","label":"Search Customer..."},model:{value:(_vm.search),callback:function ($$v) {_vm.search=$$v},expression:"search"}})],1)],1),_vm._v(" "),_c('v-simple-table',{attrs:{"dense":""},scopedSlots:_vm._u([{key:"default",fn:function(){return [_c('thead',[_c('tr',[_c('th',{staticClass:"text-left"},[_vm._v("#")]),_vm._v(" "),_c('th',{staticClass:"text-left"},[_vm._v("Client Name")]),_vm._v(" "),_c('th',{staticClass:"text-left"},[_vm._v("Client Surname")]),_vm._v(" "),_c('th',{staticClass:"text-left"},[_vm._v("Phone Number")]),_vm._v(" "),_c('th',{staticClass:"text-left"},[_vm._v("Company")]),_vm._v(" "),_c('th',{staticClass:"text-left"},[_vm._v("City")]),_vm._v(" "),_c('th',{staticClass:"text-left"},[_vm._v("Province")]),_vm._v(" "),_c('th',{staticClass:"text-left"},[_vm._v("District")]),_vm._v(" "),_c('th',{staticClass:"text-right"})])]),_vm._v(" "),_c('tbody',[(_vm.customers.length > 0)?_vm._l((_vm.customers),function(per,i){return _c('tr',{key:i},[_c('td',[_vm._v(_vm._s(i + 1))]),_vm._v(" "),_c('td',[_vm._v(_vm._s(per.name))]),_vm._v(" "),_c('td',[_vm._v(_vm._s(per.surname))]),_vm._v(" "),_c('td',[_vm._v(_vm._s(per.phone == null ? "N/A" : per.phone))]),_vm._v(" "),_c('td',[_vm._v("\n                      "+_vm._s(per.company_name == null ? "N/A" : per.company_name)+"\n                    ")]),_vm._v(" "),_c('td',[_vm._v(_vm._s(per.city == null ? "N/A" : per.city))]),_vm._v(" "),_c('td',[_vm._v(_vm._s(per.province))]),_vm._v(" "),_c('td',[_vm._v(_vm._s(per.district))]),_vm._v(" "),_c('td',{staticClass:"d-flex justify-end pt-2 pb-2"},[_c('CustomersEdit',{attrs:{"cust":per}}),_vm._v(" "),_c('CustomersDelete',{attrs:{"cust":per}})],1)])}):[_c('tr',[_c('td',{staticClass:"text-center red--text",attrs:{"colspan":"4"}},[_vm._v("\n                      No Customers yet\n                    ")])])]],2)]},proxy:true}])})],1)],1)],1)],1),_vm._v(" "),_c('v-overlay',{attrs:{"value":_vm.overlay}},[_c('v-progress-circular',{attrs:{"indeterminate":"","size":"64"}})],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/customers.vue?vue&type=template&id=4b23f84c&

// EXTERNAL MODULE: ./node_modules/vue-json-excel/dist/vue-json-excel.umd.js
var vue_json_excel_umd = __webpack_require__(525);
...
/* harmony default export */ var customersvue_type_script_lang_js_ = ({
  layout: "user",
  components: {
    downloadexcel: vue_json_excel_umd_default.a
  },
...
// CONCATENATED MODULE: ./pages/customers.vue?vue&type=script&lang=js&
 /* harmony default export */ var pages_customersvue_type_script_lang_js_ = (customersvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(16);
...
var component = Object(componentNormalizer["a" /* default */])(
  pages_customersvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
installComponents_default()(component, {CustomersAdd: __webpack_require__(564).default,CustomersEdit: __webpack_require__(565).default,CustomersDelete: __webpack_require__(566).default})
