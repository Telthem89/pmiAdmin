<template>
  <div>
      <v-btn depressed color="purple" @click="addPermModel=true" class="mr-3 white--text" >Pesepay</v-btn>
      ...
      <v-dialog v-model="addPermModel" width="500">
       ...
       <v-card>
           ...
           <v-card-text>
                  ...
                  <v-text-field
                            label="PESE INTEGRATION KEY"
                            outlined
                            v-model="form.PESE_INTEGRATION_KEY"
                            :rules="integrationKeyRule"
                        />

                        <v-text-field
                            label="PESE ENCRYPTION KEY"
                            outlined
                            v-model="form.PESE_ENCRYPTION_KEY"
                            :rules="encryptionkeyRule"
                        />
