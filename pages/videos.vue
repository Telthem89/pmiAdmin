              ...
              <template v-slot:default>
                <thead>
                  <tr>
                    ...
                    <th class="text-left">Video Code</th>
                ...
                <tbody>
                  <template v-if="videos.length > 0">
                    <tr v-for="(per, i) in videos" :key="i">
                      ...
                      <!-- <td>
                        <a :href="per.vx_videourl">{{ per.vx_name }}</a>
                      </td> -->
...
export default {
  ...
  computed: {
    videos() {
      ...
      if (this.search) {
        return data.filter(
          (dt) => !dt.vx_name.toUpperCase().indexOf(this.search.toUpperCase())
        );
      }
      return data;
    },
